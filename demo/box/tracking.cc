...
void track_event_bundle(const script::path_vector& paths,
  ...
  int Digi_numHits;
  std::vector<std::vector<int>> digi_hit_indices; ///
  ...
  auto branch_indices = integral_tree.Branch("Digi_hitIndices", "std::vector<std::vector<int>>", &digi_hit_indices, 32000, 99);
