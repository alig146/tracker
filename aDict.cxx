...
namespace ROOT {
   ...
   static void *new_vectorlEvectorlEvectorlEvectorlEintgRsPgRsPgRsPgR(void *p = 0);
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<vector<vector<vector<int> > > >*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEvectorlEvectorlEvectorlEintgRsPgRsPgRsPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<vector<vector<vector<int> > > >*)0x0)->GetClass();
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("aDict",
        ...
        TriggerDictionaryInitialization_aDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
