...
vertex::tree::tree(const std::string& name,
    ...
    : analysis::tree(name, title),
      t(emplace_branch<real_branch_value_type>("Vertex_t")),
      x(emplace_branch<real_branch_value_type>("Vertex_x")),
      y(emplace_branch<real_branch_value_type>("Vertex_y")),
      z(emplace_branch<real_branch_value_type>("Vertex_z")),
      t_error(emplace_branch<real_branch_value_type>("Vertex_errorT")),
      x_error(emplace_branch<real_branch_value_type>("Vertex_errorX")),
      y_error(emplace_branch<real_branch_value_type>("Vertex_errorY")),
      z_error(emplace_branch<real_branch_value_type>("Vertex_errorZ")),
      chi_squared(emplace_branch<real_branch_value_type>("Vertex_chi2")),
      chi_squared_per_dof(emplace_branch<real_branch_value_type>("Vertex_chi2PerNdof")),
      chi_squared_p_value(emplace_branch<real_branch_value_type>("Vertex_chi2PValue")),
      size(emplace_branch<real_branch_value_type>("Vertex_numTracks")),
      track_hash(emplace_branch<decltype(track_hash)::value_type>("Vertex_Track_hash")),
      hash(emplace_branch<decltype(hash)::value_type>("Vertex_hash")),
      _count(emplace_branch<decltype(_count)::value_type>("NumVertices")),
