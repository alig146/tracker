...
track::tree::tree(const std::string& name,
    ...
    : analysis::tree(name, title),
      ...
      vx(emplace_branch<real_branch_value_type>("Track_velX")),
      vy(emplace_branch<real_branch_value_type>("Track_velY")),
      vz(emplace_branch<real_branch_value_type>("Track_velZ")),
      t0_error(emplace_branch<real_branch_value_type>("Track_ErrorT0")),
      x0_error(emplace_branch<real_branch_value_type>("Track_ErrorX0")),
      y0_error(emplace_branch<real_branch_value_type>("Track_ErrorY0")),
      z0_error(emplace_branch<real_branch_value_type>("Track_ErrorZ0")),
      vx_error(emplace_branch<real_branch_value_type>("Track_ErrorVx")),
      vy_error(emplace_branch<real_branch_value_type>("Track_ErrorVy")),
      vz_error(emplace_branch<real_branch_value_type>("Track_ErrorVz")),
      chi_squared(emplace_branch<real_branch_value_type>("Track_chi2")),
      chi_squared_per_dof(emplace_branch<real_branch_value_type>("Track_chi2PerNdof")),
      chi_squared_p_value(emplace_branch<real_branch_value_type>("Track_chi2PValue")),
      size(emplace_branch<real_branch_value_type>("Track_numHits")),
      beta(emplace_branch<real_branch_value_type>("Track_beta")),
      beta_error(emplace_branch<real_branch_value_type>("Track_ErrorBeta")),
      angle(emplace_branch<real_branch_value_type>("Track_angle")),
      angle_error(emplace_branch<real_branch_value_type>("Track_ErrorAngle")),
      event_t(emplace_branch<real_branch_value_type>("Track_Hitt")),
      event_x(emplace_branch<real_branch_value_type>("Track_Hitx")),
      event_y(emplace_branch<real_branch_value_type>("Track_Hity")),
      event_z(emplace_branch<real_branch_value_type>("Track_Hitz")),
      event_detector(emplace_branch<decltype(event_detector)::value_type>("Track_HitdetId")),
      unique_detector_count(emplace_branch<decltype(unique_detector_count)::value_type>("Track_detCount")),
      hash(emplace_branch<decltype(hash)::value_type>("Track_hash")),
      _count(emplace_branch<decltype(_count)::value_type>("NumTracks")),
